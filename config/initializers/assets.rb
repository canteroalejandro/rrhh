...
%w( categorias departamentos empleados proyectos horarios usuarios sessions asistencias historia_medicas sexos horario_empleados check_ins check_outs roles hora_extras incidencias).each do |controller|
