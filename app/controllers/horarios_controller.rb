class HorariosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @horario.save
        format.html { redirect_to @horario, notice: 'Horario fue creado exitosamente.' }
  ...
  private
    ...
    def horario_params
      params.require(:horario).permit(:codigo, :nombre, :horaEntrada, :horaSalida, :margenEntradaCheck, :margenSalidaCheck, :inicioMargenEntrada, :finMargenEntrada, :inicioMargenSalida, :finMargenSalida, :dia => [])
    end
end
