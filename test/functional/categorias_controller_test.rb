...
class CategoriasControllerTest < ActionController::TestCase
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post :create, categoria: { fechaVigencia: @categoria.fechaVigencia, gastosMaxLuz: @categoria.gastosMaxLuz, identificador: @categoria.identificador, montoMaxFacturado: @categoria.montoMaxFacturado }
    end
  ...
  test "should update categoria" do
    put :update, id: @categoria, categoria: { fechaVigencia: @categoria.fechaVigencia, gastosMaxLuz: @categoria.gastosMaxLuz, identificador: @categoria.identificador, montoMaxFacturado: @categoria.montoMaxFacturado }
    assert_redirected_to categoria_path(assigns(:categoria))
  end
