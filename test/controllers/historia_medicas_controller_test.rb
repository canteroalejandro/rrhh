...
class HistoriaMedicasControllerTest < ActionController::TestCase
  ...
  test "should create historia_medica" do
    assert_difference('HistoriaMedica.count') do
      post :create, historia_medica: { codigo: @historia_medica.codigo, doctor: @historia_medica.doctor, fecha: @historia_medica.fecha }
    end
  ...
  test "should update historia_medica" do
    patch :update, id: @historia_medica, historia_medica: { codigo: @historia_medica.codigo, doctor: @historia_medica.doctor, fecha: @historia_medica.fecha }
    assert_redirected_to historia_medica_path(assigns(:historia_medica))
  end
