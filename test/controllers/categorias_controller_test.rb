...
class CategoriasControllerTest < ActionController::TestCase
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post :create, categoria: { codigo: @categoria.codigo, nombre: @categoria.nombre, salarioBase: @categoria.salarioBase }
    end
  ...
  test "should update categoria" do
    patch :update, id: @categoria, categoria: { codigo: @categoria.codigo, nombre: @categoria.nombre, salarioBase: @categoria.salarioBase }
    assert_redirected_to categoria_path(assigns(:categoria))
  end
