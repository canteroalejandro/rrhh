...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { codigo: @horario.codigo, diaFin: @horario.diaFin, diaInicio: @horario.diaInicio, horaFin: @horario.horaFin, horaInicio: @horario.horaInicio, nombre: @horario.nombre }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { codigo: @horario.codigo, diaFin: @horario.diaFin, diaInicio: @horario.diaInicio, horaFin: @horario.horaFin, horaInicio: @horario.horaInicio, nombre: @horario.nombre }
    assert_redirected_to horario_path(assigns(:horario))
  end
