...
class ContratosControllerTest < ActionController::TestCase
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post :create, contrato: { codigo: @contrato.codigo, edadMinima: @contrato.edadMinima, horasDia: @contrato.horasDia, nombre: @contrato.nombre, nroDuracion: @contrato.nroDuracion, tiempoDuracion: @contrato.tiempoDuracion }
    end
  ...
  test "should update contrato" do
    patch :update, id: @contrato, contrato: { codigo: @contrato.codigo, edadMinima: @contrato.edadMinima, horasDia: @contrato.horasDia, nombre: @contrato.nombre, nroDuracion: @contrato.nroDuracion, tiempoDuracion: @contrato.tiempoDuracion }
    assert_redirected_to contrato_path(assigns(:contrato))
  end
